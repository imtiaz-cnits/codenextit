...
import { ArrowRight, Code2, Globe, Laptop, Zap } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="inline-flex items-center space-x-2 px-3 py-1 rounded-full bg-brand-accent/5 border border-brand-accent/10 mb-6">
              ...
              <span className="text-[10px] font-black text-brand-accent uppercase tracking-widest">Web Engineering</span>
            </div>
            ...
            <p className="text-lg text-slate-600 dark:text-slate-400 mb-8 max-w-xl leading-relaxed font-medium">
              We build fast, responsive, and secure websites using cutting-edge technologies like Next.js, React, and Node.js to help your business stand out in the digital landscape.
            </p>
          ...
          >
            <div className="relative z-10 rounded-3xl overflow-hidden shadow-2xl border border-white/20 dark:border-white/5 bg-white dark:bg-slate-900 p-2">
              <Image
                src="/web_dev_hero_dashboard_1778193506403.png"
            ...
            <div className="absolute -top-10 -right-10 w-48 h-48 bg-emerald-500/20 rounded-full blur-3xl -z-10 animate-pulse" />
