...
import { ArrowRight, ExternalLink, Monitor, Smartphone, ShieldCheck } from 'lucide-react';
import Image from 'next/image';

const projects = [
  {
    title: "NexPOS - Smart Retail ERP",
    category: "Retail & Inventory",
    description: "A comprehensive point-of-sale solution with real-time inventory tracking, multi-branch support, and advanced sales analytics.",
    image: "/pos_showcase_1778191965606.png",
    tags: ["Real-time Sync", "Multi-store", "Analytics"],
    color: "from-blue-500 to-cyan-400"
  },
  {
    title: "MediCare - Hospital Management",
    category: "Healthcare",
    description: "Full-scale ERP for hospitals and diagnostic centers covering patient records, lab reports, billing, and pharmacy management.",
    image: "/hospital_showcase_1778191986063.png",
    tags: ["Patient Portal", "Lab Reports", "Billing"],
    color: "from-emerald-500 to-teal-400"
  },
  {
    title: "EduSmart - Academic Portal",
    category: "Education",
    description: "Digital transformation for educational institutions with student management, online results, fee collection, and HR management.",
    image: "/school_showcase.png",
    tags: ["Attendance", "Exam Engine", "Fees"],
    color: "from-indigo-500 to-purple-400"
  },
  {
    title: "StockPro - Warehouse ERP",
    category: "Supply Chain",
    description: "Optimized warehouse and supply chain management with automated stock alerts, vendor tracking, and financial reporting.",
    image: "/warehouse_showcase.png",
    tags: ["Automated Alerts", "Vendor API", "Ledger"],
    color: "from-rose-500 to-orange-400"
  }
];

export default function ManagementSoftwareShowcase() {
  return (
    <section className="py-24 bg-white dark:bg-slate-950 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-20">
          ...
          >
            Showcase of Our <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-accent to-cyan-500">Implemented Solutions</span>
          </motion.h3>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            Explore our range of successfully deployed management systems that have helped businesses transform their operations.
          </motion.p>
        </div>
                ...
                <div className="px-2">
                  ...
                  <div className="flex flex-wrap gap-2 mb-8">
                    {project.tags.map((tag, tIdx) => (
                      <span key={tIdx} className="text-[10px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-widest px-3 py-1 rounded-lg bg-slate-100 dark:bg-white/5">
                        {tag}
                      </span>
                    ))}
                  </div>
        ...
        >
          <p className="text-slate-500 font-medium mb-8">Need a custom solution for your business?</p>
          <button className="bg-brand-primary dark:bg-white text-white dark:text-brand-primary px-10 py-4 rounded-2xl font-bold hover:scale-105 transition-transform inline-flex items-center">
            Request a Free Demo <ExternalLink className="ml-2 w-5 h-5" />
          </button>
        </motion.div>
      </div>
    </section>
